--EXISTS,NOT EXISTS--
--EXISTS condition subqery'ler de kullanilir.IN ifadesinin kullanimina benzer
--EXISTS ve NOT EXISTS ifadeleri de lt sorgudan getirilen degerlerin icerisinde 
--bir degerin olmasi veya olmamasi durumunda islem ypilmasini  saglar
