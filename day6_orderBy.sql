--ORDER BY--
--ORDER BY cumlecigi bir sorgu deyimi icersinde belli bir sutuna gore siralama yapmak icin kullanilir.
...
--kisiler tablosunu adrese gore tersten sirala
select * from kisiler order by adres desc;--descending(desc) tersten siralar

--kisiler tablosunda maasi buyukten kucuge siralayin
